...
def formular():
    ...
    if form.validate_on_submit():
        ...
        return render_template("formular.html", form=form, users=user_list, message="Formular submitted")
    return render_template("formular.html", form=form, users=user_list, message="list of users")
